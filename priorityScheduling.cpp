...
//sorts the array w.r.t priority in decending order
...
int main()
{
    ...
    cout << "Please enter the arrival time, burst time and the priority of each process: " << endl;
    ...
    while(count > 0)
    {
        ...
        sort(processQueue.begin(), processQueue.end(), comparePriority);
    }
